...
module.exports = {
  ...
  devServer: {
    // contentBase: resolveAppPath('public'), // no longer supported?
    compress: true,
    historyApiFallback: true,
    hot: true,
    host,
    port: 3000,
    // publicPath: '/', // no longer supported?
  },
  ...
  resolve: {
    ...
    alias: {
      ...
      '@global': path.resolve(appDirectory, 'global'),
      '@routes': path.resolve(appDirectory, 'src/routes'),
    },
  },
