...
type PostRegisterParams struct {
	...
	/*new user account information
	  ...
	  In: body
	*/
	NewUserAccount *models.NewUserAccount
}
...
func (o *PostRegisterParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.NewUserAccount
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("newUserAccount", "body", ""))
			} else {
				res = append(res, errors.NewParseError("newUserAccount", "body", "", err))
			}
		} else {
